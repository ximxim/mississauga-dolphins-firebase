...
export const getActiveGames = memoizeOne(
  (state) => {
    const obj = {};
...
export const getScoresByGameId = memoizeOne(
  (state, id) => {
...
export const getEventById = memoizeOne(
  (state, id) => (
    state.events.items
...
export const getUpcomingGameEvents = memoizeOne(
  (state) => {
...
export const getActiveGameEvents = memoizeOne(
  (state) => {
...
export const getPastGameEvents = memoizeOne(
  (state) => {
    const ascendingFeed = _.sortBy(state.events.items, ['start_time']);
